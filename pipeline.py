...
LUA_SHA1 = get_hash(os.path.join(CWD, 'gree.lua'))
...
project = Project(
    title = 'GREE',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://wiki.archiveteam.org/images/thumb/7/75/Gree-logo.png/320px-Gree-logo.png" height="50px"/>
